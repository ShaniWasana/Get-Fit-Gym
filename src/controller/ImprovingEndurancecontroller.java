...
public class ImprovingEndurancecontroller {
    public AnchorPane lblContext;
    public Label lblIEndurance;
    ...
    private void LoadAllIE() throws ClassNotFoundException, SQLException {
        ...
        String sql="SELECT *FROM improving_endurance";
        Statement statement=con.createStatement();
        ResultSet result = statement.executeQuery(sql);
        System.out.println(result);

        ObservableList<Improving> oblist = FXCollections.observableArrayList();
        while (result.next()){
            oblist.add(
                    new Improving(
